...
export declare type CustomerSearchTermInsightResourceName = `customers/${StrNum}/customerSearchTermInsights/${StrNum}`;
/**
 * @param {string | number} customerId
 * @param {string | number} clusterId
...
export declare type CustomerSkAdNetworkConversionValueSchemaResourceName = `customers/${StrNum}/customerSkAdNetworkConversionValueSchemas/${StrNum}`;
/**
 * @param {string | number} customerId
 * @param {string | number} accountLinkId
