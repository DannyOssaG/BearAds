...
function rolePermissions(role = 'member_trial') {
  ...
  return {
    ...
    canAccessAdminPanel: ['owner','admin','billing','developer'].includes(r),
    ...
    canAccessTechnical: ['owner','developer'].includes(r),
...
function ensureWorkspaceState(workspace) {
  ...
  // ── Fase B/C/D defaults — garantizados en todas las cuentas, nuevas y viejas ──
  if (!workspace.agentMode)               workspace.agentMode = 'manual';
